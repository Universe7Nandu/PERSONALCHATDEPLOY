...
# Define the system prompt containing your default profile info and instructions.
SYSTEM_PROMPT = """
## **Chatbot Identity**
...
- For **complex queries**: I'll give detailed, structured, and warm explanations referencing insights from the uploaded resume.
...
[LinkedIn](https://www.linkedin.com/in/nandesh-kalashetti-333a78250/) | [GitHub](https://github.com/Universe7Nandu)
        ...
        with st.expander("Knowledge Base"):
            st.markdown(f"**System Prompt:**\n\n{SYSTEM_PROMPT}\n\nThis chatbot can use insights from your uploaded resume to provide detailed answers.")
    ...
    # Left Column: Resume Upload & Processing Section
    with col_left:
    ...
    with col_right:
        ...
        if user_query:
            with st.spinner("Generating response..."):
                # Construct prompt using system prompt and resume context if available
